...
public class BoxDialog extends JDialog {
	...
	private Integer boxSearchId = 0;
	private Integer boxAddQuantity = 1;
	...
	public BoxDialog(Window owner, String title) {
		...
		panelCenter.add(createBoxAddTablePanel());
	...
	public Integer getBoxSearchId() {
		return this.boxSearchId;
	}

	public Integer getBoxAddQuantity() {
